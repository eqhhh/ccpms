    ...
    <el-dialog title="提示" v-model="dialogVisible" width="30%">
      <el-form :model="form" label-width="120px">
        ...
        <el-form-item label="状态：">
          <el-radio v-model="form.state" label="运行中">运行中</el-radio>
          <el-radio v-model="form.state" label="维修中">维修中</el-radio>
          <el-radio v-model="form.state" label="禁用">禁用</el-radio>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    exportStation(){
      location.href = "http://" + window.server.filesUploadUrl + ":9090/smallTableExportCsv?table=station";
    }
  }
}
</script>
